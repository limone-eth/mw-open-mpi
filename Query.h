...
#pragma omp critical (factor1)
            ...
            // CHECK FACTOR 2
            if (!Utils::in_array(car_accidents[i].factor_2, already_processed_factors) && car_accidents[i].factor_2 != "") {
...
#pragma omp critical (factor2)
            ...
            // CHECK FACTOR 3
            if (!Utils::in_array(car_accidents[i].factor_3, already_processed_factors) && car_accidents[i].factor_3 != "") {
...
#pragma omp critical (factor3)
            ...
            // CHECK FACTOR 4
            if (!Utils::in_array(car_accidents[i].factor_4, already_processed_factors) && car_accidents[i].factor_4 != "") {
...
#pragma omp critical (factor4)
            ...
            // CHECK FACTOR 5
            if (!Utils::in_array(car_accidents[i].factor_5, already_processed_factors) && car_accidents[i].factor_5 != "") {
